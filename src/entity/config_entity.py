...
class DataIngestionConfig:
    ...
    data_ingestion_feature_store_dir: str = DATA_INGESTION_FEATURE_STORE_DIR
    data_ingestion_ingested_dir: str = DATA_INGESTION_INGESTED_DIR
    feature_store_file_path: str = FILE_NAME
    training_file_path: str = TRAIN_FILE_NAME
    testing_file_path: str = TEST_FILE_NAME
